...
elseif(strpos($result2, "succeeded")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CHARGED '.$amt.' ✅ @aguilanegra0 </span><br>';
exit;
}

elseif(strpos($result2, "Your card has insufficient funds.")) {

    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: INSUFFICIENT FUNDS ⚠️ @aguilanegra0 </span><br>';
    exit;
    }
...
elseif(strpos($result2, "incorrect_zip")) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅ @aguilanegra0 </span><br>';
    exit;
    }

elseif(strpos($result2, 'security code is incorrect.')) {

    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CCN LIVE ✅ @aguilanegra0 </span><br>';
    exit;
    }
...
elseif(strpos($result2, "transaction_not_allowed")) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: TRANSACTION NOT ALLOWED ❌ @aguilanegra0 </span><br>';
    exit;
    }
...
elseif(strpos($result2, "stripe_3ds2_fingerprint")) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: 3DSECURE REQUIRED ❌ @aguilanegra0 </span><br>';
    exit;
    }
elseif(strpos($result2, "generic_decline")) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE ❌ @aguilanegra0 </span><br>';
    }

elseif(strpos($result2, "do_not_honor")) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: DO NOT HONOR ❌ @aguilanegra0 </span><br>';
